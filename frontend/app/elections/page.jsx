                      ...
                      <h3 style={{
                        ...
                        <div style={{ display: "flex", gap: 8, marginTop: 16 }}>
                          <button
                            ...
                            style={{ flex: 1, padding: "10px", borderRadius: 12, border: `1px solid ${t.border}`, background: t.pill, color: dark ? "#5cc97f" : "#1B6B3A", fontSize: 13, fontWeight: 600, cursor: "pointer", fontFamily: "DM Sans, sans-serif" }}>
                            👥 View Candidates
                          </button>
                          <button
                            onClick={() => router.push(`/ballot/${election.id}`)}
                            style={{ flex: 1, padding: "10px", borderRadius: 12, border: "none", background: "linear-gradient(135deg, #1B4D2E, #2D8C4E)", color: "white", fontSize: 13, fontWeight: 600, cursor: "pointer", fontFamily: "DM Sans, sans-serif" }}>
                            🗳 Vote Now
                          </button>
