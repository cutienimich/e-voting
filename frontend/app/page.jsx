...
export default function LandingPage() {
  ...
  return (
    // OUTER WRAPPER — always white, centers the phone column
    <div style={{ background: dark ? "#0A0A0A" : "#FFFFFF", minHeight: "100vh", fontFamily: "'DM Sans', sans-serif", display: "flex", justifyContent: "center", alignItems: "flex-start" }}>
      ...
      {/* PHONE COLUMN — dirty white (light) or dark bg, max 430px */}
      <div style={{ background: t.bg, color: t.text, width: "100%", maxWidth: 430, minHeight: "100vh", boxShadow: dark ? "0 0 80px rgba(0,0,0,0.6)" : "0 0 60px rgba(0,0,0,0.08)", transition: "all 0.3s ease" }}>
        ...
        {/* NAV — logo left, toggle right */}
        <nav style={{ padding: "16px 24px", display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "space-between", borderBottom: `1px solid ${t.border}`, position: "sticky", top: 0, background: t.bg, zIndex: 100, backdropFilter: "blur(10px)" }}>
...
const theme = {
  light: {
    bg: "#F5F3EE",       // dirty white — phone area
    card: "#ECEAE4",     // slightly darker card
    text: "#0D0D0D",
    subtext: "#6B7280",
    border: "#DDD9D0",
  },
